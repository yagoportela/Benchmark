...
public interface IDynamoDBRepository
{
    ...
    Task<List<ValorDynamoDB>> GetValorFamiliaDataAsync(string nomeFamilia);
    Task<List<ValorDynamoDB>> GetValorSerieFamiliaAsync(string nomeSerie, string nomeFamilia, DateOnly dataInicioVigencia);
    Task<List<ValorDynamoDB>> GetValorSerieFamiliaAsync(string nomeSerie, string nomeFamilia);
    Task<List<ValorDynamoDB>> GetValorSerieAtributoDataAsync(string nomeSerie, string nomeAtributo, DateOnly dataInicioVigencia);
    Task<List<ValorDynamoDB>> GetValorSerieAtributoAsync(string nomeSerie, string nomeAtributo);
    Task<List<ValorDynamoDB>> GetItemSerieAtributoAsync(string nomeSerie, string nomeAtributoDataInicioVigencia);
    Task<List<ValorDynamoDB>> GetValorSerieDataAsync(string nomeSerie, DateOnly dataInicioVigencia);
    Task<List<ValorDynamoDB>> GetValorSerieDataAsync(string nomeSerie);
